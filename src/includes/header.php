...
<body>
    <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="blue" data-image="../assets/img/logo.png">
            <div class="logo bg-info"><a href="./" class="simple-text logo-normal">
                    Opticas
                </a></div>
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="armazon.php">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Sistema de Productos</a>
                    </div>
