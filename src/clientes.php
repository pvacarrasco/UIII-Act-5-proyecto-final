    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO cliente(nombre,telefono,direccion,correo,usuario,apellidos,cp,ciudad) values ('$nombre', '$telefono', '$direccion','$correo','$usuario','$apellidos','$cp','$ciudad')");
                if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE cliente SET nombre = '$nombre' , telefono = '$telefono', direccion = '$direccion',correo = '$correo',usuario='$usuario',apellidos = '$apellidos', cp='$cp',ciudad='$ciudad'  WHERE idcliente = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                        Cliente Modificado
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="col-md-12">
                ...
                <form action="" method="post" autocomplete="off" id="formulario">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="apellidos" class="text-dark font-weight-bold">Apellidos</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Ingrese cp" name="cp" id="cp" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="ciudad" class="text-dark font-weight-bold">Ciudad</label>
                                <input type="text" placeholder="Ingrese ciudad" name="ciudad" id="ciudad" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 mt-3">
                            <input type="submit" value="Registrar" class="btn btn-warning" id="btnAccion">
