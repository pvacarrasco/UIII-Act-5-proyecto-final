...
$ventas = mysqli_query($conexion, "SELECT d.*, p.codproducto, p.descripcion FROM detalle_venta d INNER JOIN productos p ON d.id_producto = p.codproducto WHERE d.id_venta = $id");
